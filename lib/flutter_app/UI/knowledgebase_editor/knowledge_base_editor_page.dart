...
class KnowledgeBaseEditorPage extends StatefulWidget {
  const KnowledgeBaseEditorPage({super.key});

  @override
  State<KnowledgeBaseEditorPage> createState() =>
      _KnowledgeBaseEditorPageState();
}

class _KnowledgeBaseEditorPageState extends State<KnowledgeBaseEditorPage> {
  ...
  void _initWebView() {
    ...
    if (!kIsWeb && (Platform.isIOS || Platform.isAndroid)) {
      ...
      _controller = WebViewController()
        ...
        ..loadRequest(Uri.parse('http://localhost:4200/knowledgebase-editor'));
    } else {
      _isSupported = false;
      _isLoading = false;
    }
